    ...
    if (isset($_POST['username'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<li><a href='admin.results.php?username=" . htmlspecialchars($row["username"]) . "'><img class='imagesrc' id='imagesrc' src='$filesfound[0]'>" . htmlspecialchars($row["username"]) . "</a></li><br>";
            }
            echo "</div>";
        } else {
